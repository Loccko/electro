  ...
  >
    <div class="u-sidebar__scroller">
      <div class="u-sidebar__container">
        <div
          class="js-scrollbar u-header-sidebar__footer-offset pb-3 mCustomScrollbar _mCS_2 mCS-autoHide mCS_no_scrollbar"
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="js-scrollbar u-sidebar__body mCustomScrollbar _mCS_3 mCS-autoHide"
                style="position: relative; overflow: visible"
              >
                <div
                  id="mCSB_3"
                    ...
                    <div class="u-sidebar__content u-header-sidebar__content">
                      <form class="js-validate" novalidate="novalidate" @submit.prevent.stop>
                        ...
                        <div id="login" data-target-group="idForm" v-if="mode == 'login'">
                          ...
                          <div class="text-center mb-4" @click="mode='registartion'">
                        ...
                        >
                          ...
                          <div class="form-group">
                            <div class="js-form-message js-focus-state">
                              <label class="sr-only" for="signupEmail">
                                Email
                              </label>
                              <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <input
                                  ...
                                  data-msg="Please enter a valid email address."
                                  :class="{
                                    'u-has-error': email && email.indexOf('@') < 0,
                                    'u-has-success': email && email.indexOf('@') > 0,
                                  }"
                                  v-model="email"
                                />
                              </div>
                            ...
                            <div class="js-form-message js-focus-state">
                              ...
                              <div class="input-group">
                                ...
                                <input
                                  ...
                                  data-msg="Your password is invalid. Please try again."
                                  :class="{
                                    'u-has-error': password && confirmedPassword !== password,
                            ...
                            <div class="js-form-message js-focus-state">
                              ...
                              <div class="input-group">
                                ...
                                <input
                                  ...
                                  :class="{
                                    'u-has-error': confirmedPassword && confirmedPassword !== password,
    ...
    async login(){
      if(this.email && this.password) {
        ...
        if(response && response.data && response.data.authorizeUser) {
          this.AutAPI.writeTokensToLS(response.data.authorizeUser)
        }
      }
    }
  }
