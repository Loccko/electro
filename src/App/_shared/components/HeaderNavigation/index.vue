            ...
            <ul class="list-inline mb-0">
              ...
              >
                ...
                >
                  ...
                  <span class="text-gray-50">or</span> Sign in
                </a>
    ...
    <div class="py-2 py-xl-4 bg-primary-down-lg">
      <div class="container my-0dot5 my-xl-0">
        <div class="row align-items-center">
            ...
            >
              ...
              >
                <ul class="navbar-nav u-header__navbar-nav">
                  ...
                  >
                    <router-link id="HomeMegaMenu" class="nav-link u-header__nav-link"
                      aria-haspopup="true"
                      aria-expanded="false"
                  ...
                  <li class="nav-item u-header__nav-item">
                    <a class="nav-link u-header__nav-link" href="about.html"
                      >About us</a
                    >
                  </li>
                  <!-- End About us -->
                  ...
                  <!-- FAQs -->
                  <li class="nav-item u-header__nav-item">
                    <a class="nav-link u-header__nav-link" href="faq.html"
                      >FAQs</a
                    >
                  </li>
                  <!-- End FAQs -->
            ...
            <div class="d-flex">
              ...
              <div class="ml-2">
                <div class="phone">
                  ...
                  <a href="tel:800856800604" class="text-gray-90"
                    >(+800) 856 800 604</a
                  >
                </div>
                <div class="email">
                  E-mail:
                  <a
                    href="mailto:info@electro.com?subject=Help Need"
                    class="text-gray-90"
                    >info@electro.com</a
                  >
                </div>
          ...
          <!-- Header Icons -->
          <div
            class="d-xl-none col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static"
          >
