      ...
      <div class="container">
        <div class="d-flex align-items-center">
          <div class="topbar-left">
            <router-link to="/" class="text-gray-110 font-size-13 u-header-topbar__nav-link">
              Welcome to Electro <span v-if="user">{{ ', ' + user.data.firstName + ' ' + user.data.lastName }}</span>
            </router-link>
          </div>
          <div class="topbar-right ml-auto">
            <ul class="list-inline mb-0">
              <li v-if="!user" @click="$emit('openAuth')" class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                <a role="button"
        ...
        <div class="row align-items-center">
          <div class="col-auto">
            <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
              <router-link to="/" class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" aria-label="Electro">
                <svg
                    version="1.1"
                    x="0px"
                    y="0px"
            ...
            <div class="d-flex">
              ...
              <div class="ml-2">
                <div class="phone">
                  ...
                  <a href="tel:800856800604" class="text-gray-90"> +38 066-355-55-55</a>
                </div>
                <div class="email">
                  E-mail:
