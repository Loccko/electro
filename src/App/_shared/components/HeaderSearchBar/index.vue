              ...
              <div class="max-width-270 min-width-270">
                ...
                <div id="basicsAccordion">
                  ...
                  <div class="card border-0 rounded-0">
                    <div
                      class="card-header bg-primary rounded-0 card-collapse border-0"
                      id="basicsHeadingOne"
                    >
                      <button
                        type="button"
                              ...
                              >
                                ...
                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" style="height: calc(100% + 1px) !important;" aria-labelledby="basicMegaMenu">
                                  <div class="vmm-bg">
                                    <img
                                      class="img-fluid"
                                      :src="rootCategory.images.size500x400.link"
                                      alt="Image Description"
                                      style="opacity: 0.1;"
                                    />
                                  </div>
                                  <div class="row u-header__mega-menu-wrapper">
                                    <div class="col-4 mb-4 mb-sm-0" 
                                      v-for="subcategory of rootCategory.subcategories"
                                      :key="subcategory.id"
                                    >
              ...
              <form class="js-focus-state">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    <!-- End Select -->
                    <button
                      class="btn btn-dark height-40 py-2 px-3 rounded-right-pill"
                      type="button"
                      id="searchProduct1"
                    >
                ...
                <ul class="d-flex list-unstyled mb-0">
                  ...
                  <li class="col pr-0">
                    ...
                    >
                      ...
                      >
                      <span
                        class="font-weight-bold font-size-16 text-gray-90 ml-3"
                        >$1785.00</span
                      >
                    </a>
                  </li>
