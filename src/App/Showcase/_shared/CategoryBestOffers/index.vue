<template>
  <div class="mb-8">
    ...
    >
      <h3 class="section-title mb-0 pb-2 font-size-22">{{ items.title }}</h3>
    </div>
    <div class="row">
      <div class="col-auto">
        <a href="../shop/shop.html" class="d-block">
          <img
            class="img-fluid"
            :src="items.images.size212x305.link"
      ...
      <div class="col">
        <ul class="row list-unstyled products-group no-gutters">
          <li class="col-6 col-md-4 col-wd-3 product-item" v-for="i of 3" :key="i">
            <product-card :item="items.products[i]"/>
          </li>
        </ul>
      </div>
    </div>
