...
export default {
  ...
  async beforeRouteEnter(to, from, next) {
    const products = await Products.fetchProducts(null, null, null, null, to.params.search)
  ...
  methods: {
    ...
    async filter() {
      this.products = await Products.fetchProducts(null, null, this.sortingOrder, null, this.search)
